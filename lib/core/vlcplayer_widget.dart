...
class VLCVideoWidget extends StatefulWidget {
  ...
  @override
  State<VLCVideoWidget> createState() => _VLCVideoWidgetState();
}
...
class _VLCVideoWidgetState extends State<VLCVideoWidget> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      debugPrint(
          "VLCVideoWidget width=${constraints.maxWidth * window.devicePixelRatio}, height=${constraints.maxHeight * window.devicePixelRatio}");
